...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        Route::redirect('/', 'admin/excel-import', 301)->name('admin');
        Route::get('dashboard', [SectionController::class, 'dashboard'])->name('dashboard.index');
        Route::get('excel-import', [SectionController::class, 'excel_import'])->name('excel-import.index');
        Route::post('excel/import', [ExcelController::class, 'excelImport'])->name('excel.import');
        Route::get('vnedu-import', [SectionController::class, 'vnedu_import'])->name('vnedu-import.index');
        Route::post('vnedu/import', [ExcelController::class, 'vneduImport'])->name('vnedu.import');
        Route::post('excel/export', [ExcelController::class, 'excelExport'])->name('excel.export');
        ...
        Route::get('coordinate-presets', [SectionController::class, 'coordinate_presets'])->name('coordinate-presets.index');
    });
});
